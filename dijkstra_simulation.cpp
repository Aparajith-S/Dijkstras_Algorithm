...
float DijkstraSimulation::runDijkstraAverage(std::string source)
{
	int i = 0;
	float averageCost = 0;
...
void DijkstraSimulation::printGraph()
{
...
void DijkstraSimulation::print_path(const std::vector<std::string>& path, const std::string& srcNode)
{
...
void DijkstraSimulation::weight_generator()
{
...
void DijkstraSimulation::random_graph_generator()
{
	for (uint32 i = 0; i < numOfVertices - 1; i++)
	{
		for (uint32 j = 0; j < numOfVertices; j++)
...
void DijkstraSimulation::reGraph(float probDensity)
{
	density = probDensity;
	random_graph_generator();
}

float DijkstraSimulation::probability_density()
{
